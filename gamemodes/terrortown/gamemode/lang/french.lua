...
local L = LANG.CreateLanguage("Français", "fr")
...
L.limit_round      = "Limite de rounds atteinte. {mapname} va bientôt charger."
...
L.body_found       = "{finder} a trouvé le corps de {victim}. {role}"
...
L.equip_help_carry = "Vous ne pouvez acheter que où vous avez de la place."
...
L.equip_custom     = "Objet ajouté par ce serveur."
...
L.disg_help2     = "Appuyez sur Numpad Enter pour basculer sur le déguisement sans le menu. Vous pouvez aussi configurer une touche à 'ttt_toggle_disguise' avec la console."
...
L.xfer_success    = "Transfert de crédit vers {player} effectué."
L.xfer_received   = "{player} vous a donné {num} crédit(s)."
...
L.search_dmg_bullet = "Il est évident qu'on l'a abattu."
L.search_dmg_fall   = "Il a fait une chute fatale."
...
L.search_dmg_drown  = "Le corps montre les signes d'une noyade, sans aucun doute."
...
L.search_dmg_car    = "Pendant que cette personne traversait la route, ils s'est fait rouler dessus par un conducteur imprudent."
...
L.search_head   = "La balle qui l'a abattu a été portée à la tête. Impossible de crier."
L.search_time   = "Il est mort environ {time} avant que vous fassiez l'enquête."
...
L.buy_no_stock    = "Cette arme est à court de stock : vous l'avez déjà acheté pour ce round."
...
L.dna_menu_help1  = "Voici les échantillons ADN que vous avez récupéré."
L.dna_menu_help2  = [[
...
L.tele_no_ground  = "Impossible de téléporter à moins d'être sur du sol solide !"
...
L.tele_no_mark_ground = "Impossible de marquer une position à moins d'être sur du sol solide !"
L.tele_no_mark_crouch = "Impossible de marquer une position en étant accroupi !"

L.tele_help_pri   = "{primaryfire} téléporte vers la position marquée."
...
L.ammo_gravity    = "Munitions Poltergeist"
...
L.target_credits = "Fouiller pour récupérer crédits non dépensés"
...
Surveillez vos arrières, et bossez avec vos camarades pour vous en sortir en vie !]]

L.info_popup_detective = [[Vous êtes un Détective ! Le QG Terroriste vous a donné des ressources spéciales pour trouver les Traitres.
Utilisez-les pour aider les innocents à survire, mais attention :
...
Mais soyez prudent, ou votre trahison pourrait être révélée au grand jour...
...
L.idle_popup = [[Vous avez été absent {num} secondes et avez donc été mis dans le mode Spectateur uniquement. Dans ce mode, vous n'apparaîtrez pas quand un nouveau round démarre.

Vous pouvez basculer hors de ce mode quand vous voulez en appuyant sur {helpkey} et en décochant la case correspondante dans l'onglet Options. Vous pouvez aussi choisir de le désactiver maintenant.]]
...
L.spec_mode_warning = "Vous êtes en mode Spectateur et vous n'apparaîtrez pas quand un round commence. Pour désactivez ce mode, appuyez sur F1, allez dans les Options et décochez 'Mode Spectateur uniquement'."
...
L.tip2 = "Amorcer un explosif C4 avec un minuteur plus long va augmenter le nombre de fils qui causeront une explosion imminente quand un innocent essaiera de la désamorcer. L'explosif beepera plus doucement et à moins grande fréquence."

L.tip3 = "Les Détectives peuvent fouiller un corps pour trouver qui se 'reflète dans ses yeux'. C'est la dernière personne que le mort a vu. Ce n'est pas forcement le tueur si le mort a été tué dans le dos."
...
L.tip9 = "Le Poltergeist peut transformer n'importe quel objet physique en un projectile mortel. Chaque coup est accompagné de coups d'énergie qui hurte tout le monde à proximité."

L.tip10 = "Traitre ou Détective, gardez à l'œil les messages rouges en haut à droite. Ils sont importants pour vous."

L.tip11 = "Traitre ou Détective, gardez en tête que vous sont récompensés des crédits d'équipement si vos camarades et vous vous débrouillez bien. Pensez à les dépenser !"
...
L.tip13 = "Quand vous êtes proches de quelqu'un quand vous le tuez, un peu de votre ADN est déposé sur le corps. Cet ADN peut être utilisé pour le Scanner ADN d'un Détective pour vous localiser. Vous feriez mieux de cacher le corps quand vous plantez quelqu'un !"

L.tip14 = "Plus vous étiez loin de quelqu'un que vous tuez, plus vite le dépôt d'ADN sur son corps se dégradera."

L.tip15 = "Vous êtes Traitre et vous allez sniper ? Essayez le Déguisement. Si vous ratez voter coup, trouvez un endroit sécurisé, désactivez le Déguisement, et personne ne saura que c'était vous qui a tiré."

L.tip16 = "En tant que Traitre, le Téléporteur peut vous aider à vous enfuir quand on vous traque, et vous permet de voyager rapidement à travers une grande carte. Assurez-vous de marquer une position sécurisée en amont."

L.tip17 = "Les innocents sont tous groupés et vous n'arrivez pas à un en isoler un ? Pourquoi pas utiliser la Radio pour jouer des sons de C4 ou d'un coup de feu pour les mener ailleurs ?"

L.tip18 = "Avec la Radio, en tant que Traitre, vous pouvez jouer des sons dans votre Menu des Équipements après que la radio a été placée. Mettez en attente plusieurs sons en cliquant sur plusieurs boutons dans l'ordre dans lequel vous voulez qu'ils soient joués."

L.tip19 = "En tant que Détective, si vous avez des crédits en réserve, vous pourriez donner à un innocent de confiance un Démineur. Vous pourriez ensuite vous consacrer à un travail sérieux d'investigation et leur laisser le désamorçage risqué."
...
L.tip22 = "La Station de Soins enregistre un échantillon ADN de ceux qui l'utilisent. Les Détectives peuvent l'utiliser avec le Scanner ADN pour trouver qui s'est soigné avec."
...
L.tip24 = "Appuyez sur {helpkey} pour voir un court tutoriel ou modifier des options spécifiques à TTT. Par exemple, vous pouvez désactiver ces astuces pour de bon."

L.tip25 = "Quand un Détective fouille un corps, les résultats sont disponibles pour tous les joueurs à travers le tableau des scores, en cliquant sur le nom de la personne morte."

L.tip26 = "Dans le tableau des scores, une loupe à côté du nom de quelqu'un indique que vous avez déjà cherché des informations à propos de cette personne. Si l'icône est lumineuse, les données viennent d'un Détective et peuvent contenir plus d'informations."
...
L.tip28 = "Les Spectateurs peuvent appuyer sur {mutekey} pour basculer entre mute les spectateurs et les joueurs vivants."

L.tip29 = "Si le serveur a installé des langues en plus, vous pouvez changer la langue quand vous le souhaitez dans le menu Options."

L.tip30 = "Les commandes de tchat rapide ou 'radio' sont accessibles avec {zoomkey}."

L.tip31 = "En tant que Spectateur, appuyez sur {duckkey} pour déverrouiller votre curseur et cliquer sur les boutons sur le panneau des astuces. Appuyez encore sur {duckkey} pour revenir en vue normale."

L.tip32 = "L'alt-fire du Pied de biche pousse les autres joueurs."

L.tip33 = "Tirer avec le viseur d'une arme augmentera légèrement votre précision et réduira le recul. S'accroupir, en revanche, non."
...
L.tip36 = "Le tutoriel accessible avec {helpkey} contient un aperçu des touches les plus importantes du jeu."

L.tip37 = "Sur le tableau des scores, cliquez sur le nom d'un joueur vivant et vous pouvez lui apposer un label comme 'suspect' or 'ami'. Ce label apparaîtra sur la personne concernée en dessous de votre réticule."
...
L.tip40 = "Si vous voyez 'MODE HÂTIF' au-dessus du chrono du round, le round ne durera au début que quelques minutes, mais chaque mort prolongera le temps restant (comme capturer un point de contrôle dans TF2). Ce mode met la pression aux traitres pour qu'ils se bougent."
...
L.report_tab_events_tip = "Journal des événements du round"
L.report_tab_scores = "Scores"
L.report_tab_scores_tip = "Points marqués par joueur dans ce round uniquement"
...
L.ev_shot        = "{victim} s'est fait tirer dessus par {attacker}"
L.ev_shot_using  = "{victim} s'est fait tirer dessus par {attacker} avec un {weapon}"
...
L.ev_burn        = "{victim} s'est fait griller par {attacker}"
L.ev_burn_using  = "{victim} a brûlé par {trap} à cause de {attacker}"
...
L.ev_slash_using = "{victim} s'est fait planter par {attacker} avec {trap}"

L.ev_tele        = "{victim} s'est fait téléfrag par {attacker}"
L.ev_tele_using  = "{victim} s'est fait atomiser par {attacker} en utilisant {trap}"

L.ev_goomba      = "{victim} s'est fait écraser par la masse imposante de {attacker}"

L.ev_crush       = "{victim} s'est fait broyer par {attacker}"
L.ev_crush_using = "{victim} s'est fait broyer par {attacker} avec {trap}"
...
L.ev_c4_plant    = "{player} a planté du C4"
L.ev_c4_boom     = "Le C4 planté par {player} a explosé"
L.ev_c4_disarm1  = "{player} a désamorcé le C4 planté par {owner}"
L.ev_c4_disarm2  = "{player} a échoué le déminage du C4 planté par {owner}"
L.ev_credit      = "{finder} a trouvé {num} crédit(s) sur le corps de {player}"

L.ev_start       = "Le round a commencé"
L.ev_win_traitor = "Les odieux traitres remportent la victoire !"
L.ev_win_inno    = "Les adorables innocents remportent la victoire !"
L.ev_win_time    = "Les traitres ont manqué de temps et ont perdu !"

--- Awards/highlights

L.aw_sui1_title = "Leader du Culte du Suicide"
L.aw_sui1_text  = "a montré aux autres suicidaires comment on fait en y allant le premier."
...
L.aw_exp2_text  = "a testé sa résistance aux explosions. Elle était bien trop faible."

L.aw_fst1_title = "Premier Sang"
L.aw_fst1_text  = "a servi la première mort d'un innocent sur le plateau d'un traitre."

L.aw_fst2_title = "Premier Sang d'un Idiot"
L.aw_fst2_text  = "a fait la peau le premier a un allié traitre. Bien joué."

L.aw_fst3_title = "Premier... BÊtisier"
L.aw_fst3_text  = "a été le premier à tuer. Bien dommage que c'était un camarade innocent."

L.aw_fst4_title = "Premier Coup"
L.aw_fst4_text  = "a frappé le premier coup pour les terroristes innocents en abattant en premier un traitre."
...
L.aw_nkt2_text  = "a montré que le premier n'était pas dû à la chance en tuant un autre gaillard."
...
L.aw_fal1_text  = "a poussé quelqu'un d'une certaine hauteur."

L.aw_fal2_title = "AtterrÉ"
L.aw_fal2_text  = "a laissé son corps se fracasser sur le sol après être tombé d'une hauteur remarquable."

L.aw_fal3_title = "La MÉtÉorite Humaine"
L.aw_fal3_text  = "a écrasé quelqu'un en lui tombant dessus d'une haute altitude."

L.aw_hed1_title = "Efficace"
L.aw_hed1_text  = "a découvert la joie des headshots et en a fait {num}."

L.aw_hed2_title = "Neurologie"
L.aw_hed2_text  = "a retiré le cerveau de {num} têtes pour un examen minutieux."
...
L.aw_pst1_title = "Le P'tit Salaud de Forceur"
L.aw_pst1_text  = "a tué {num} personnes avec un pistolet. Puis il a câliné quelqu'un à mort."
...
L.aw_sgn1_text  = "met les balles où ça fait mal, {num} terroristes en ont fait les frais."

L.aw_sgn2_title = "1000 Petites Balles"
L.aw_sgn2_text  = "n'aimait pas vraiment son plomb, donc il a tout donné. {num} n'ont pas pu vivre le moment."
...
L.aw_dgl2_text  = "a flingué {num} joueurs avec un deagle."
...
L.aw_sip1_text  = "a fermé le clapet à {num} pipelette(s) avec un pistolet silencieux."

L.aw_sip2_title = "Assassin Silencieux"
L.aw_sip2_text  = "a tué {num} personnes qui ne se sont pas entendues mourir."
...
L.aw_knf3_title = "Quel Homme So-scie-able !"
L.aw_knf3_text  = "a trouvé {num} couteaux à usage unique par terre, et les a utilisés."

L.aw_knf4_title = "Un Schlasseur Sachant Schlasser"
L.aw_knf4_text  = "a buté {num} types au couteau. Ne me demandez pas comment."

L.aw_flg1_title = "À la rescousse"
L.aw_flg1_text  = "a utilisé son pistolet de détresse pour signaler {num} morts."

L.aw_flg2_title = "FusÉe = Feu"
L.aw_flg2_text  = "a montré à {num} hommes que c'est dangereux de porter des vêtements inflammables."

L.aw_hug1_title = "Expansion Digne D'un H.U.G.E"
L.aw_hug1_text  = "est entré en harmonie avec son H.U.G.E et a dirigé les balles vers {num} hommes."
...
L.aw_msx1_text  = "en a dégommé {num} avec le M16."

L.aw_msx2_title = "Maladie MÉtrage Moyen"
L.aw_msx2_text  = "sais foudroyer avec son M16, et il l'a prouvé à {num} victimes."

L.aw_tkl1_title = "Oups..."
L.aw_tkl1_text  = "a vu son doigt glisser quand il visait un copain."

L.aw_tkl2_title = "Double Oups"
L.aw_tkl2_text  = "a cru qu'il a eu deux Traitres, mais s'est doublement trompé."

L.aw_tkl3_title = "OÙ Est Mon Karma ?!"
L.aw_tkl3_text  = "ne s'est pas arrêté après avoir buté deux coéquipiers car jamais deux sans trois."
...
L.aw_tkl6_text  = "n'a pas compris dans quel camp il était, et a tué la moitié de ses camarades."

L.aw_tkl7_title = "Plouc"
L.aw_tkl7_text  = "a vraiment bien protégé son territoire en tuant plus d'un quart de ses collègues."
...
L.aw_brn2_text  = "a été entendu rire aux éclats après avoir calciné une de ses victimes."

L.aw_brn3_title = "BrÛleur Pyrrhique"
L.aw_brn3_text  = "les a tous cramés, et maintenant il est à court de grenades incendiaires ! Et comment il va faire, maintenant !?"
...
L.set_avoid_det_tip = "Activez ceci pour demander au serveur de ne pas être choisi en tant que Détective si c'est possible. Vous ne serez pas forcément Traitre plus souvent."
...
--- 2021-06-07
L.sb_playervolume = "Volume du joueur"
...
L.set_cross_color_enable = "Activer couleur personnalisée"
L.set_cross_color = "Couleur du réticule"
